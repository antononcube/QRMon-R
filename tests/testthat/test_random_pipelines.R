...
pipelineLevels <-
  list( level1 = c( "QRMonUnit()",
        ...
        level3 = c( "QRMonQuantileRegression",
                    "QRMonQuantileRegression( df = 6, degree = 7, fractions = 0.5)",
                    "QRMonQuantileRegression( df = 12, fractions = c(0.1,0.9))",
                    "QRMonQuantileRegression( df = 12, fractions = 1:5/6)",
                    "QRMonQuantileRegression( df = 12, fractions = runif( runif(1, min = 1, max = 6), min = 0, max = 1) )"),
